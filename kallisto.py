...
def download_accession(output_dir, entrez_email='eholleman@luc.edu'):
    ...
    SeqIO object to a fasta file which then can be passed into the make_kalisto_index
    function. Returns the absolute path to the accession fasta file as a string
    and the number of coding sequences as an int both in a tuple.
    '''
    ACC = 'EF999921.1'
